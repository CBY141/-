...
public class GameEvent extends Event {
    ...
    public static GameEvent gamePaused() {
        return new GameEvent(EventType.GAME_PAUSED, null, null);
    }

    public static GameEvent gameResumed() {
        return new GameEvent(EventType.GAME_RESUMED, null, null);
    }
    ...
    public static GameEvent gameSaved(String saveName) {
        return new GameEvent(EventType.GAME_SAVED, null, saveName);
    }

    public static GameEvent gameLoaded(String saveName) {
        return new GameEvent(EventType.GAME_LOADED, null, saveName);
    }
    ...
    public static GameEvent playerScored(Player player, int score) {
        return new GameEvent(EventType.PLAYER_SCORED, player, score);
    }
    ...
    public static GameEvent enemyHit(Enemy enemy, int damage) {
        return new GameEvent(EventType.ENEMY_HIT, enemy, damage);
    }
    ...
    public static GameEvent bulletHit(Point position, Object target) {
        return new GameEvent(EventType.BULLET_HIT, target, position);
    }
    ...
    public static GameEvent inputMoved(int x, int y) {
        return new GameEvent(EventType.INPUT_MOVED, null, new Point(x, y));
    }

    public static GameEvent inputShoot(boolean shooting) {
        return new GameEvent(EventType.INPUT_SHOOT, null, shooting);
    }

    public static GameEvent resourceLoaded(String resourceName) {
        return new GameEvent(EventType.RESOURCE_LOADED, null, resourceName);
    }

    public static GameEvent configChanged(String key, Object value) {
        return new GameEvent(EventType.CONFIG_CHANGED, null,
    ...
    public static GameEvent achievementUnlocked(String achievementId) {
        return new GameEvent(EventType.ACHIEVEMENT_UNLOCKED, null, achievementId);
    }
}