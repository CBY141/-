...
public class Bullet {
    ...
    public void draw(Graphics g) {
        ...
        switch (direction) {
            case GameConfig.DIR_UP: g.fillOval(x - 1, y + 3, 2, 4); break;
            case GameConfig.DIR_DOWN: g.fillOval(x - 1, y - 7, 2, 4); break;
            case GameConfig.DIR_LEFT: g.fillOval(x + 3, y - 1, 4, 2); break;
            case GameConfig.DIR_RIGHT: g.fillOval(x - 7, y - 1, 4, 2); break;
        }
    }
